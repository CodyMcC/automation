...
CD Audio	application/x-cdf	.cda	Wikipedia: CDA File
...
GZip	application/gzip	.gz	Wikipedia: GZip
...
JavaScript Module	text/javascript	.mjs	Wikipedia: Javascript
...
JSON - Linked Data	application/ld+json	.jsonld	Wikipedia: JSON-LD
...
MIDI	audio/midi	.midi	Wikipedia: MIDI
...
MPEG Transport Stream	video/mp2t	.ts	Wikipedia: MPEG Transport Stream
...
Opus Audio	audio/opus	.opus	Wikipedia: Opus Audio
...
mime_types = re.findall('[a-zA-Z-.0-9]+/[a-zA-Z-.0-9]+', page)
print(mime_types)
print(len(mime_types))